...
const getToken = () => {
  ...
  myHeaders.append(
    ...
    "https://ec2-44-206-45-82.compute-1.amazonaws.com:8443/"
  );
  ...
  fetch(
    "https://ec2-44-206-45-82.compute-1.amazonaws.com:8443/auth/realms/master/protocol/openid-connect/token",
    requestOptions
  ).then((response) =>
    response
      .json()
...
const keyCloakRegisterUser = (raw) => {
  ...
  return fetch(
    "https://ec2-44-206-45-82.compute-1.amazonaws.com:8443/auth/admin/realms/PSTravel/users",
    requestOptions
  );
};
...
const getJwtToken = () => {
  ...
  return fetch(
    "https://ec2-44-206-45-82.compute-1.amazonaws.com:8443/auth/realms/PSTravel/protocol/openid-connect/token",
    requestOptions
  );
...
const sendEmailVerification = (id) => {
  ...
  return fetch(
    `https://ec2-44-206-45-82.compute-1.amazonaws.com:8443/auth/admin/realms/PSTravel/users/${id}/send-verify-email`,
    requestOptions
  );
};
...
const getUserFromEmail = (email) => {
  ...
  return fetch(
    `https://ec2-44-206-45-82.compute-1.amazonaws.com:8443/auth/admin/realms/PSTravel/users?email=${email}`,
    requestOptions
  );
};
...
//   return fetch(
//     `${baseUrl}/realms/PSTravel/protocol/openid-connect/token`,
//     requestOptions
//   );
//   // .then((response) => response.text())
//   // .then((result) => console.log(result))
